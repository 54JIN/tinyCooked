public class Condiments {
    //pointers
    Condiments head;
    Condiments previous;//refer to next as in normal notion
    ...
    public Condiments(String name, double price, int calorie){
        this.name=name;
        this.price=price;
    ...
    public Condiments(String name,int quantity, double price ){
        this.name=name;
        this.price=price;
        this.calorie=-1;
    ...
    public Condiments(String name, double price, int calorie,int quantity){
        this.name=name;
        this.price=price;
        this.calorie=calorie;
        this.quantity=quantity;
    ...
    public void addCondiments(String name, double price, int calorie, int quantity){
        Condiments temp= new Condiments(name,price,calorie,quantity);
        if(head == null){
            head=temp;
        }
        else{
    ...
    public boolean removeCondiments(String name){
        Condiments cursor=head;
        Condiments next=null;
    ...
    public Condiments getCondiments(String name){
        if(head==null){
            return null;
        }
        else{
    ...
    public static void main(String args[]){
        ...
        Condiments head= new Condiments();
